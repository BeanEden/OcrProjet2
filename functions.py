...
def verification_page_2(url_page):
    """Verifie l'existence d'une seconde page dans la categorie"""
    soup = soup_function(url_page)
...
def thread_creation_livre(liste_url):
    """Threading de la fonction creation_un_livre
    Argument : liste de l'ensemble des urls des livres de la categorie
    Retourne une liste"""
